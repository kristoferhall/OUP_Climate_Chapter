...
# airt
my.wt.m40.airt <- analyze.wavelet(m40, 
                                  my.series = "airt", 
                                  make.pval = TRUE, 
                                  n.sim = 200)
...
# airt
my.wt.m40_d.airt <- analyze.wavelet(m40_d, 
                                    "airt", 
                                    make.pval = TRUE, 
                                    n.sim = 200)

wt.image(my.wt.m40_d.airt, 
         main = "Met 40 - Daily Mean Air Temperature",
...
maximum.level = 1.001 * max(my.wt.m40_d.airt$Power.avg)
wt.avg(my.wt.m40_d.airt, maximum.level = maximum.level)


# maxair
my.wt.m40_d.maxair <- analyze.wavelet(m40_d, "maxair", make.pval = TRUE, n.sim = 20)

wt.image(my.wt.m40_d.maxair, 
         main = "Met 40 - Daily Maximum Air Temperature",
         periodlab = "period (Daily)",
         label.time.axis = TRUE,
         show.date = TRUE,
         color.key = "quantile",
...
maximum.level = 1.001 * max(my.wt.m40_d.maxair$Power.avg)
wt.avg(my.wt.m40_d.maxair, maximum.level = maximum.level)



# minair
my.wt.m40_d.minair <- analyze.wavelet(m40_d, "minair", make.pval = TRUE, n.sim = 20)

wt.image(my.wt.m40_d.minair, 
         main = "Met 40 - Daily Minimum Air Temperature",
         periodlab = "period (Daily)",
         label.time.axis = TRUE,
         show.date = TRUE,
         color.key = "quantile",
...
maximum.level = 1.001 * max(my.wt.m40_d.minair$Power.avg)
wt.avg(my.wt.m40_d.minair, maximum.level = maximum.level)


# rh
my.wt.m40_d.rh <- analyze.wavelet(m40_d, "rh", make.pval = TRUE, n.sim = 20)

wt.image(my.wt.m40_d.rh, 
         main = "Met 40 - Daily Mean Relative Humidity (%)",
         periodlab = "period (Daily)",
         label.time.axis = TRUE,
         show.date = TRUE,
         color.key = "quantile",
...
maximum.level = 1.001 * max(my.wt.m40_d.rh$Power.avg)
wt.avg(my.wt.m40_d.rh, maximum.level = maximum.level)


# ppt
my.wt.m40_d.ppt <- analyze.wavelet(m40_d, "ppt", make.pval = TRUE, n.sim = 20)

wt.image(my.wt.m40_d.ppt, 
         main = "Met 40 - Daily Total Precipitation (mm)",
         periodlab = "period (Daily)",
         label.time.axis = TRUE,
         show.date = TRUE,
         color.key = "quantile",
...
maximum.level = 1.001 * max(my.wt.m40_d.ppt$Power.avg)
wt.avg(my.wt.m40_d.ppt, maximum.level = maximum.level)
...
# cross-wavelet for ppt and rh
m_df <- data.frame(m40_d)

my.wc.ppt_rh <- analyze.coherency(m_df, c("ppt", "rh"), n.sim = 50)
...
my.wc.ppt_airt <- analyze.coherency(m_df, c("ppt", "airt"), n.sim = 50)
